...
export const map = curryN(2, function(fn, l) {
    for (var key in l) {
        l[key] = fn(l[key], key)
    }
    return l
...
export const filter = curryN(2, function(fn, obj) {
    var ret = {}
...
export const prop = curryN(2, function(key, obj) {
    return obj[key]
})

export const invoker = curryN(2, function invoker(arity, method) {
...
export const fnInvoker = curryN(2, function(fn, method) {
    return invoker(arity(fn), method)
})

export const methods = filter(function(f) {
    return typeof f === "function"
})

export const mapFields = curryN(3, function(keys, fn, obj) {
    for (var i = 0; i < keys.length; ++i) {
...
export const rearg = curryN(2, function(newOrder, fn) {
...
export const apply = curryN(2, function(fn, arr) {
    return fn.apply(this, arr)
})

export const omit = curryN(2, function(keys, obj) {
    for (var i = 0; i < keys.length; ++i) {
        delete obj[keys[i]]
    }
    return obj
...
export const to = curryN(2, function(toMap, obj) {
...
export const mapTo = curryN(2, function(fromToMap, obj) {
