...
class Devtools {
    ...
    /*
      ...
      will be rerendered using the "commit" event and "force" flag.

      It will also replace the "runTree" method of the store to
    ...
    */
    sendInitial() {
        const initialModel = this.store.state.get()
        const message = JSON.stringify({
            type: 'init',
            version: this.VERSION,
            data: {
    ...
    */
    ...
    /*
      The container will listen to "commit" events from the store
