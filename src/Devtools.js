        ...
        if (this.remoteDebugger) {
            ...
            this.ws.onclose = () => {
                if (this.isBrowserEnv) {
                    console.warn(
                        "You have configured remoteDebugger, but could not connect. Falling back to Chrome extension"
                    );
                    this.reInit();
                } else {
                    console.warn(
                        "You have configured remoteDebugger, but could not connect. Please start the remote debugger and make sure you connect to correct port"
                    );
                }
            };
            this.ws.onerror = () => {
            ...
            console.warn(
                "The Cerebral devtools is running in a non browser environment. You have to add the remoteDebugger option"
            );
        }
